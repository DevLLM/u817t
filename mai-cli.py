...
"""
🦥 Starter Script for Fine-Tuning FastLanguageModel with MAI

This script is designed as a starting point for fine-tuning your models using mai.
...
Usage: (most of the options have valid default values this is an extended example for demonstration purposes)
    python mai-cli.py --model_name "mai/llama-3-8b" --max_seq_length 8192 --dtype None --load_in_4bit \
    --r 64 --lora_alpha 32 --lora_dropout 0.1 --bias "none" --use_gradient_checkpointing "mai" \
...
def run(args):
    import torch
    from mai import FastLanguageModel
    from datasets import load_dataset
    from trl import SFTTrainer
    from transformers import TrainingArguments
    from mai import is_bfloat16_supported
    import logging
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="🦥 Fine-tune your llm faster using mai!")

    model_group = parser.add_argument_group("🤖 Model Options")
    model_group.add_argument('--model_name', type=str, default="mai/llama-3-8b", help="Model name to load")
    ...
    lora_group.add_argument('--use_gradient_checkpointing', type=str, default="mai", help="Use gradient checkpointing")
    ...
    save_group.add_argument('--quantization', type=str, default="q8_0", nargs="+",
        help="Quantization method for saving the model. common values ('f16', 'q4_k_m', 'q8_0'), Check our wiki for all quantization methods https://github.com/maiai/mai/wiki#saving-to-gguf ")
